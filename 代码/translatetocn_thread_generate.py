...
# 读取CSV文件
df = pd.read_csv('origindata/韩语/cleaned.csv')  # 请将'your_file.csv'替换为您的实际文件路径
...
# 保存回原CSV文件
df.to_csv('origindata/韩语/cleaned.csv', index=False, encoding='utf-8')

print("翻译完成！结果已保存回原文件 origindata/韩语/cleaned.csv")
